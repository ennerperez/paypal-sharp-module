...
namespace PayPal.Services
{
    public class SubscriptionService : ISubscriptionService
    {
        ...
        public async Task<Subscription> CreateAsync(Subscription model)
        {
            ...
            var result = await client.HttpClient.PostAsync($"{client.Url}v1/billing/subscriptions", content);
        ...
        public async Task<Subscription> DetailsAsync(string id)
        {
            ...
            var result = await client.HttpClient.GetAsync($"{client.Url}v1/billing/subscriptions/{id}");
            if (!result.IsSuccessStatusCode)
        ...
        public async Task<bool> CancelAsync(string id, string reason)
        {
            ...
            var result = await client.HttpClient.PostAsync($"{client.Url}v1/billing/subscriptions/{id}/cancel", content);
            if (!result.IsSuccessStatusCode)
